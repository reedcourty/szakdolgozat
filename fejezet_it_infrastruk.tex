...
\subsubsection{Privát számítási felhő (\foreignlanguage{english}{Private cloud})}
...
A felhő infrastruktúrát kizárólagosan egy egyedüli szervezet használja, amely magába foglal több előfizetőt (pl. üzleti egységeket). Lehet a szervezet saját tulajdona, kezelheti és üzemeltetheti maga a szervezet, de akár egy harmadik fél, vagy a kettőnek kombinációja, és lehet a szervezet telephelyén, vagy máshol is.

\subsubsection{Közösségi számítási felhő (\foreignlanguage{english}{Community cloud})}
...
\subsubsection{Publikus számítási felhő (\foreignlanguage{english}{Public cloud})}
...
\subsubsection{Hibrid számítási felhő (\foreignlanguage{english}{Hybrid cloud})}
