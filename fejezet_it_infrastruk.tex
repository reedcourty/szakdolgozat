...
\todo{Megvalósítások MySQL-nél, PostgreSQL-nél, stb.}
...
Erre a problémára nyújthat megoldást például az Apache webszerver beépített \textit{mod\_proxy\_balancer} modulja, amely kezeli ezeket a sessionöket, és terheléselosztást is megvalósít. 
