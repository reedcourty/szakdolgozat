...
\begin{comment}
\foreignlanguage{english}{''Moving up the stack, the next level of service is the platform (Platform-as-a-Service,
...
format) along with access to necessary services such as a MySQL database or
other, specialized local resources. In other words, PaaS is IaaS with a custom
software stack for the given application.''}\cite{ccwlinux}
\end{comment}
